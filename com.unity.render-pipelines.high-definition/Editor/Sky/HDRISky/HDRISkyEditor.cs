...
namespace UnityEditor.Rendering.HighDefinition
{
        ...
        : SkySettingsEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            bool backPlateDrawn = PropertyField(m_EnableBackplate, new GUIContent("Backplate", "Enable the projection of the bottom of the CubeMap on a plane with a given shape ('Disc', 'Rectangle', 'Ellispe', 'Infinite')"));
            if (backPlateDrawn && m_EnableBackplate.value.boolValue)
            {
                EditorGUI.indentLevel++;
